...
**Adding a guest through the Add to Organization dialog**
...
-   Choose a role “Guest”;
-   Select the desired project where the participant will be added;
...
If you set the expiration date for the guest, then in the list of participants you can see how much time is left before the end of the guest’s stay in the organization. At the end of the period, the guest is automatically removed from the organization and it will be necessary to add again.
...
-   Change the name and surname of the participant;
-   Change the avatar;
...
Open the desired project in the list of workspaces.

Click on their name.

In the menu that appears, find the guest in the Members list.
...
**Deleting from organization**

Open the list of members of the organization.
