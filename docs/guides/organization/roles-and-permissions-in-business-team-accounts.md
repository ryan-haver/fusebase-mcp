...
## Types of accounts in organizations [#](#b1345687109_0)

-   Organization **Owner** and **Managers** have access to all workspace and to the organization’s console.
...
You can read more about the differences between roles here – [https://thefusebase.com/guides/getting-started/key-role-differences/](https://thefusebase.com/guides/getting-started/key-role-differences/)
...
-   **Admin** – users can edit pages, add new pages, and share your pages through public pages. They can also control access to workspace pages and folders.
...
## Inviting Members and Clients to the Portal [#](#3-toc-title)
...
Unlike members or guests, clients have access only to the portal and do not have access to the Internal Space.
