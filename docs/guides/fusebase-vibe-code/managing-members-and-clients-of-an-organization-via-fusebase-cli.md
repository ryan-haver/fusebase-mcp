...
lastScraped: "2026-09-12T05:17:51.267Z"
---
...
## What Fusebase CLI Can Currently Do for Managing Organization Members: [#](#0-toc-title)
...
## What use cases can be implemented in AI apps using the User API? [#](#1-toc-title)
...
## Is it possible to grant access to a feature to specific roles? [#](#17-toc-title)
...
## Is it possible to set up sending invites to an organization or portal through a feature? [#](#3-toc-title)
...
## Can clients create accounts themselves? [#](#5-toc-title)
...
## Is there an option to sign in to the app via Google or Microsoft? [#](#6-toc-title)
...
![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20866'%3E%3C/svg%3E)

## Is it possible to customize the appearance of emails sent when inviting users to the app? [#](#7-toc-title)
