...
lastScraped: "2026-09-15T04:45:04.256Z"
---
...
What’s the difference between a Frontend App and a Backend App? A Frontend App is about what people see and interact with. It helps you create things like landing pages, forms,...
...
1.  [What’s the difference between a Frontend App and a Backend App?](#b1913696101_35083)
2.  [Are there any specifics to creating backend apps?](#1-toc-title)
3.  [Is there support for Python and cron?](#2-toc-title)
4.  [Is it possible to integrate apps with other services? How are keys and other private data stored?](#3-toc-title)
5.  [Is it possible to send emails through the Fusebase app? For example, notifications?](#4-toc-title)

## **What’s the difference between a Frontend App and a Backend App?**
...
## Are there any specifics to creating backend apps?
...
## Is there support for Python and cron?
...
## Is it possible to integrate apps with other services? How are keys and other private data stored?
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2026/03/image-40-1024x336.png)

Next, click Edit next to the required secret, enter the key, token, or other necessary information, and save it.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2026/03/image-41-1024x322.png)
...
## Is it possible to send emails through the Fusebase app? For example, notifications?
