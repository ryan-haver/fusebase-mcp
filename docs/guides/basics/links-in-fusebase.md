...
To mention a page, just do the following.

-   Click on the arrow in the editor to display **More items**.
-   Select **Mention** or use **@**.
...
When you share a page with the internal link, users who are not authorized in FuseBase and are not members of your organization will not have an access to pages through the link.

-   Right-click on the page in pages list.
...
-   Press on the three dots next to the desired block.
-   Select **Copy link**.
...
-   Click on the menu and select Embed or press **cmd/ctrl** + **⌥/alt** + **m**.
-   Insert the link to the desired embed.

Examples of embed links:

-   Youtube – [https://www.youtube.com/watch?v=ihPdwnVixYc](https://www.youtube.com/watch?v=ihPdwnVixYc)
-   Github – [https://gist.github.com/gdb/b6365e79be6052e7531e7ba6ea8caf23](https://gist.github.com/gdb/b6365e79be6052e7531e7ba6ea8caf23)
-   InVision – [https://invis.io/QZCS6QO2R](https://invis.io/QZCS6QO2R)
...
Also, you can enable the display of the embed in full-width mode. For this, click in the embed menu and activate Full Width in the Layout item.
...
-   Copy any link.
-   Press **cmd/ctrl** + **k** for link or **cmd/ctrl** + **⌥/alt** + **5** for button.
-   Paste the link.
-   Specify the text where the link will be hidden under.
-   For button, you can also specify its style.
