...
[Fusebase](https://thefusebase.com/note/) has a chat where you can communicate both privately in private messages and publicly in channels with other members.

Add your coworkers to the Fusebase workspace and start setting up your successful workflow.

-   Chat 1-to-1 with your colleagues;
-   Create public channels for your whole company;
-   Discuss particular tasks in private channels and mention your teammates; 
...
-   New Public Channel – allows you to create a new channel.
...
To join an existing channel, select it from the list, click on it and click Join this channel at the bottom of the window.

Each channel has a block of options, including:

-   Renaming a channel.
-   Change channel status to private/public.
-   Channel exit.
...
Several options are available under the messages:

-   Message reply
-   Editing a message (only available for messages you’ve sent)
-   Deleting a message (only available for messages you’ve sent)
