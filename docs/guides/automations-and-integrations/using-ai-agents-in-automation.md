...
lastScraped: "2026-09-15T04:44:56.943Z"
---
...
Not long ago, we released our AI agents—designed to help with a wide range of routine tasks. But you can go beyond using them individually by creating entire agent systems through...
...
1.  [Creating an Agent for Competitor Research](#0-toc-title)
2.  [Creating the Automation Flow](#1-toc-title)

Not long ago, we released our [AI agents](/guides/fusebase-ai/ai-agents-quick-guide)—designed to help with a wide range of routine tasks. But you can go beyond using them individually by creating entire agent systems through our automation module.
...
## **Creating an Agent for Competitor Research**
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-31-1024x834.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-33-896x1024.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-34-1024x591.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-35-1024x659.png)

For the response format, select Markdown. Don’t forget to click Step test or Load data to fetch the data for the next step.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-36-1024x716.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-39-1024x704.png)

In the Message field, insert the response from the agent.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-40-1024x730.png)
