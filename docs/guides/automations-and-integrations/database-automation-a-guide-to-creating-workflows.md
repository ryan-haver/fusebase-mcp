...
lastScraped: "2026-09-15T04:44:52.734Z"
---
...
In Fusebase, you can fully automate working with your databases and dashboards. With automation, you can significantly simplify managing tasks, the sales pipeline, vacancies, and...
...
1.  [The New database and New table triggers](#1-toc-title)
2.  [New row added](#2-toc-title)
3.  [Row updated](#3-toc-title)
4.  [When row matches conditions](#4-toc-title)
5.  [Create new database](#6-toc-title)
6.  [Create new table in new or existing database](#7-toc-title)
7.  [Create row in existing table](#8-toc-title)
8.  [Update row in existing table](#9-toc-title)
9.  [Find Row](#10-toc-title)
10.  [Get Row’s Columns Value](#11-toc-title)

In Fusebase, you can fully automate working with your [databases](/guides/table-database/custom-databases-quick-guide) and [dashboards](/guides/dashboard-crm/dashboard-overview-managing-workspaces-portals-and-clients). With automation, you can significantly simplify managing tasks, the sales pipeline, vacancies, and much more.
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/12/image-12-1024x710.png)

## The New database and New table triggers
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/12/image-13-1024x692.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/12/image-18-1024x739.png)

## When row matches conditions
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/12/image-14-1024x686.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/12/image-15-1024x713.png)

# Actions

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-27-1024x689.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-28-1024x687.png)

## **Create new table in new or existing database**
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-29-1024x685.png)
