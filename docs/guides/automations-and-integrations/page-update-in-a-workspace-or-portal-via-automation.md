...
lastScraped: "2026-09-15T04:44:56.992Z"
---
...
In FuseBase, you can automate not only the creation of new pages but also the updating of existing ones. For example, you can create a page with competitor news and have it...
...
In FuseBase, you can automate not only the [creation of new pages](/guides/automations-and-integrations/automation-of-page-creation-in-the-portal) but also the updating of existing ones.
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-50-1024x578.png)

4) Next, we need to set up the search for competitor news. We’ll do this using our [AI agents](/guides/fusebase-ai/ai-agents-quick-guide). In fact, we already provide a default agent called Competitor Releases, which is preconfigured for this exact purpose.

Select FuseBase AI Agents as the first action, and choose the agent named Competitor Releases.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-51-1024x667.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-52-1024x700.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-53-1024x669.png)

Next, select the Workspace, the folder, and the specific page where competitor news will be added.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-54-1024x684.png)

In Content Format, select HTML, and in Content, choose the Response from the agent.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-57-1024x684.png)

In Context Position, specify where the new content should be added: at the top of the page or at the bottom.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-56-1024x696.png)

All set! Now, news about your competitors will be automatically gathered and added to the selected page.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-58-1024x523.png)
