...
lastScraped: "2026-09-15T04:44:57.657Z"
---
...
As you know, FuseBase has its own AI Assistant that knows everything about your workspace and allows you to answer questions about its content. You can read more about the...
...
As you know, FuseBase has its own AI Assistant that knows everything about your workspace and allows you to answer questions about its content. You can read more about the assistant here: [https://thefusebase.com/guides/fusebase-ai/ai-assistant-quick-guide/](/guides/fusebase-ai/ai-assistant-quick-guide).

This is a very powerful tool, and now its capabilities can also be automated using our [automation module](/guides/automations-and-integrations/fusebase-automation-quick-guide). With the **ASK AI Assistant** action, you can: create summaries and reports based on workspace data, generate documents and training courses using data from the workspace, and much more.
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-1024x664.png)

Next, in the list of actions, select **ASK AI Assistant**. It consists of several customizable parameters.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-1-1024x559.png)

First, select the workspace you need.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-2-1024x649.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-3-1024x540.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-4-1024x548.png)

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-5-1024x679.png)

In the **Response Format**, select **HTML** so the assistant provides the response with the correct formatting.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-6-1024x635.png)

Click **Test Step** to receive test data. This data will be needed for the next step.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-11-1024x527.png)

Next, we need to set up email sending. To do this, create the action **Send Email**.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-7-1024x660.png)

In the **Recipient** field, select the desired recipient. In our case, you can choose your email address.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-8-1024x680.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-9-1024x671.png)

Next, click **Publish** to publish the flow.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/01/image-10-1024x669.png)
