...
-   **Events**: A list of all events that occurred on the portal.
-   **Sessions**: A list of each client’s sessions. A session is the time interval when a client logged into the portal (session start) and logged out of the portal (session end).
...
-   **The name and email of the client** who performed an action on the portal.
...
-   **User name and email**
-   **User IP address**
-   **Page from which the session started**
