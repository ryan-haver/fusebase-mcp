...
-   Send a portal chat message offering assistance
-   Check analytics to see which content they explored
-   Identify when an existing client returns to the portal
-   Respond quickly when a new client creates an account
...
A notification is triggered when the portal is accessed by:

-   An anonymous visitor
-   A user with the Client role
-   A member who does not have access to the portal customizer

Visits from portal managers are excluded, so your own activity and your team’s management work will not create unnecessary notifications.
...
-   The portal name
-   The first page opened during the session
-   A link to the page where the session started
...
Disable **Allow notifications about portal visitors** if you no longer want to receive these emails. This setting applies to both portal visit and new client account notifications.
