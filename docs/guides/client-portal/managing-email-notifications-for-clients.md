...
-   Task notifications
-   Notifications about other events, such as page edits or file uploads in the portal

It is important to note that certain notifications will still be sent regardless, for example:

-   Magic Link emails
-   Document signature requests
-   Direct mentions in chat and comments and so on
