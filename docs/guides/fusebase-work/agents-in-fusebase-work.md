...
lastScraped: "2026-09-12T05:18:59.007Z"
---
...
## The Agent List[](https://docs.paperclip.ing/guides/org/agents/#the-agent-list) [#](#the-agent-list)
...
### Information shown for each agent [#](#3-toc-title)
...
### Creating an agent from the list [#](#4-toc-title)

Select **New Agent** in the upper-right corner of the Agents page to start the hiring process covered in the next section.

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20387'%3E%3C/svg%3E)

## Hiring a New Agent [#](#5-toc-title)
...
### Role and reporting structure [#](#7-toc-title)
...
### Adapter and configuration [#](#8-toc-title)
...
### Approvals for agent-proposed hires [#](#10-toc-title)
...
## The Agent Detail Page [#](#12-toc-title)

![](data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%20355'%3E%3C/svg%3E)
...
### Managed and external bundles [#](#19-toc-title)
...
### Recommended structure: AGENTS, SOUL, HEARTBEAT, and TOOLS [#](#21-toc-title)
...
#### Writing `HEARTBEAT.md` [#](#23-toc-title)
...
#### When a single file is enough [#](#25-toc-title)
...
#### How FuseBase Work creates instruction files [#](#26-toc-title)
...
### Adapters without bundle support [#](#28-toc-title)
...
### When changes take effect [#](#29-toc-title)
...
### Information shown for each skill [#](#32-toc-title)
...
### How skills are applied [#](#34-toc-title)
...
## Configuration Tab [#](#36-toc-title)
...
### Configuration form [#](#37-toc-title)
...
### Configuration revisions [#](#39-toc-title)
...
### Canceling, retrying, and resuming runs [#](#45-toc-title)
...
### Sorting and filters [#](#46-toc-title)
...
### Budget policy card [#](#49-toc-title)
...
### What happens at each threshold [#](#51-toc-title)
...
### Agent and company budgets [#](#52-toc-title)
...
## How Agents Run: The Heartbeat Model [#](#58-toc-title)
...
### Session persistence [#](#61-toc-title)
...
### Practical implications [#](#63-toc-title)
...
### Troubleshoot an agent [#](#66-toc-title)
...
### Pause an agent temporarily [#](#67-toc-title)
...
### Rotate an API key [#](#68-toc-title)
...
### Increase an agent’s budget [#](#69-toc-title)
