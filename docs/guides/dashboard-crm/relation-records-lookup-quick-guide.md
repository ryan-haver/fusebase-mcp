...
lastScraped: "2026-09-15T04:44:53.525Z"
---
...
In Fusebase databases there are smart columns that allow you to create connections between different tables and even different databases and dashboards: Relations and Lookup. What...
...
1.  [What is Relation Records?](#0-toc-title)
2.  [What is Lookup?](#1-toc-title)
3.  [How to add a Relation link to another row?](#2-toc-title)
4.  [Add a Lookup column](#3-toc-title)
5.  [Project management use case – using Relations and Lookup in practice](#4-toc-title)
...
## How to add a Relation link to another row?

1) Click to create a new column.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-10-1024x402.png)

2) Select Relation.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-11-835x1024.png)

3) Next, you need to choose the database or dashboard whose rows you will link to.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-12-725x1024.png)

4) Also, you need to choose the table and the view.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-13.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-14-1024x820.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-15.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-16-1024x479.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-17-1024x671.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-18-1024x457.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-19-1024x526.png)

2) Select Lookup.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-20-616x1024.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-21-966x1024.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-22.png)

6) That’s it — now the column displays data from the source table (if this data has been added).

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-23-1024x570.png)

## Project management use case – using Relations and Lookup in practice
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-24-1024x446.png)

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-25-1024x487.png)

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/11/image-26-1024x432.png)
