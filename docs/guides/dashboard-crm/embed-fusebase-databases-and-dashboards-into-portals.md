...
lastScraped: "2026-09-15T04:44:34.937Z"
---
...
You can use Fusebase dashboards and databases not only for internal work, but also give your clients access to them in the portal, with the ability not only to view but also to...
...
1.  [Adding a database to the portal](#0-toc-title)
2.  [Embed settings](#1-toc-title)
3.  [Filtering for embeds](#2-toc-title)
4.  [Dynamic filters](#3-toc-title)
5.  [Is it possible to filter rows by portal?](#4-toc-title)
...
## Adding a database to the portal

1) Go to the desired page in the portal or create a new one.

2) Click on Add Block and select Fusebase Database.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-74-1024x484.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-75-1024x484.png)

4) Next, select the desired dashboard or database, as well as the view you want to display in the portal.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-76-1024x507.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-77-1024x489.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-78-1024x457.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-79-1024x361.png)
...
### Is it possible to filter rows by portal?
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-87-1024x491.png)

2) Add a relation to the portals dashboard.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-88-1024x497.png)

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-89.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-90-1024x309.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/10/image-91-1024x385.png)
