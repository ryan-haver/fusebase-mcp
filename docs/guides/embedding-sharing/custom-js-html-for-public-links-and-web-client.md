...
lastScraped: "2026-09-15T04:44:47.850Z"
---
...
FuseBase has a function for adding custom code from other services, which will be displayed on public links (folders and pages) and/or in the web client.
...
1.  [Adding a new script](#b745032984_747)
2.  [Scripts management](#b745032984_3859)
3.  [Editing the script](#b745032984_5724)
4.  [Useful links](#b778331315_36)
...
![Go to workspaces management. In the menu select the desired workspace.](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/Ocfb37o1pkAh7ebY/image.png)

3) Select Custom HTML/JS –

![Select Custom HTML/JS](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/m1GErC1nw7BAjMwN/image.png)

4) Next, you will see the script management page –

![Next, you will see the script management page](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/iQOSnSqGA3EYMmzq/image.png)

5) To add a script, you need to click on the button “Add HTML/JS” –

![To add a script, you need to click on the button "Add HTML/JS"](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/z3lrTzVpPnlhfvF2/image.png)
...
![After adding the script code, you need to save it. When you're ready, press Publish.](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/KFc0CIy4MPNJ4LyS/image.png)
...
![You can easily find it in the "Custom HTML / JS" section.](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/hZxapFCHnrnaT45t/image.png)
...
![You can also sort the script names alphabetically](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/kl8uIHd8N9oJsvuv/image.png)

In addition to general information, each script has a separate menu with actions –

![In addition to general information, each script has a separate menu with actions](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/YVuruWVbaz6s8vJn/image.png)
...
![As mentioned above, the “Edit” button in the menu of each script allows you to edit it.](/hosting-assets/legacy/thefusebase/box/attachment/4080931/bk8trab1r981msdpx5n3/zOwwc6yvVMy8yOtN/image.png)
...
Adding support for fonts from Google Fonts to public links – [https://thefusebase.com/guides/embedding-sharing/adding-support-for-fonts-from-google-fonts-to-public-links/](/guides/embedding-sharing/adding-support-for-fonts-from-google-fonts-to-public-links)

Adding Google Analytics to public pages using custom scripts – [https://thefusebase.com/guides/branding/adding-google-analytics-to-public-pages-using-custom-scripts/](/guides/branding/adding-google-analytics-to-public-pages-using-custom-scripts)

Adding Intercom chat to public pages using custom scripts – [https://thefusebase.com/guides/embedding-sharing/adding-intercom-chat-to-public-pages-using-custom-scripts/](/guides/embedding-sharing/adding-intercom-chat-to-public-pages-using-custom-scripts)
