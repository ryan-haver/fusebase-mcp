...
section: "fusebase-ai"
lastScraped: "2026-09-15T04:44:44.332Z"
---
...
As you know, you can use AI agents not only in the web client but also in our browser extension. One of the major advantages of agents in the extension is their ability to...
...
As you know, you can use [AI agents](/guides/fusebase-ai/ai-agents-quick-guide) not only in the web client but also in our [browser extension](/guides/fusebase-ai/fusebase-ai-assistant-browser-extension). One of the major advantages of agents in the extension is their ability to understand the content of the current page you’re viewing, and we’ll show you how to successfully leverage this capability for your agents.
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-17-1024x649.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-18-1024x693.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-19-1024x575.png)

3) Now let’s test how the new agent works. To do this, open the desired article and click on the agent from the list.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-20-1024x556.png)

As a result, we’ll get a convenient summary of the article in the form of questions and answers. Super handy!

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/04/image-21-1024x553.png)
