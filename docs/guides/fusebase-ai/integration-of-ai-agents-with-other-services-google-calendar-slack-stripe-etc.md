...
section: "fusebase-ai"
lastScraped: "2026-09-15T04:44:44.328Z"
---
...
Our agents not only allow you to search the Internet, your knowledge base, or generate new content, but also fully integrate with the services you use. This way, our agents become...
...
2.  [Connecting Integrations to Your Agent](#1-toc-title)
3.  [Rules for MCP Integrations](#2-toc-title)
4.  [Connecting your own tool or integration](#3-toc-title)
...
## Connecting Integrations to Your Agent
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-1-1024x419.png)

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-2-1024x703.png)

2) Find Google Calendar in the list.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-3-1024x739.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-4-1024x997.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-5-1024x753.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-6-1024x849.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-7-1024x721.png)

3) Click on Create new rule. Next, enter a name for your rule set and define the actual rules.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-8-838x1024.png)

4) Then, save the rule set.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/Без-названия.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-9-1024x979.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-10-801x1024.png)

Important: Any changes you make will automatically apply to all agents where the integration using this rule is active.

## Connecting your own tool or integration
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-21-1024x549.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-22-1024x603.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-23-1024x593.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-24-1024x921.png)

9) Next, you will see a link to the MCP server that you need to copy.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/05/image-25-1024x669.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-11-1024x492.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-12-1024x751.png)
