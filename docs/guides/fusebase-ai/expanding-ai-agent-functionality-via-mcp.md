...
section: "fusebase-ai"
lastScraped: "2026-09-15T04:44:44.212Z"
---
...
What is MCP? MCP (Model Context Protocol) is a technology that lets our AI agents connect and work with your favorite apps and services.Think of it as a universal remote: instead...
...
2.  [Connecting a recommended MCP](#1-toc-title)
3.  [Connecting MCP from an external source](#2-toc-title)

## **What is MCP?**

MCP (Model Context Protocol) is a technology that lets our [AI agents](/guides/fusebase-ai/ai-agents-quick-guide) connect and work with your favorite apps and services.  
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-36-1024x575.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-38.png)

4) If you selected **Org Auth**, you can either log in to your service account or choose from an existing connection.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-39.png)

If you selected **User Auth**, then when opening the agent, users will first need to connect to the service.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-40-1024x580.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-41-1024x581.png)

## Connecting MCP from an external source
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-23-1024x538.png)

4) Scroll down and select Use API or MCP.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-24-1024x541.png)

5) In the pop-up window, choose MCP and copy the link.

![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-25-1024x537.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-26-1024x500.png)
...
![](/hosting-assets/legacy/thefusebase/wp-content/uploads/2025/06/image-27-1024x563.png)
