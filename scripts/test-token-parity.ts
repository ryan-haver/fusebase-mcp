...
async function runParityValidation() {
  ...
  // Setup credentials
  const gateToken = process.env.FUSEBASE_GATE_TOKEN || "3bed3dad75ef17a08ab5308963c7975ef6ab53d76dfdcfd5bd2f7d5e6bd04459";
  const dashboardsToken = process.env.FUSEBASE_DASHBOARDS_TOKEN || "b5a46a92e30ada618ff6ffb45e667a2c97ae4cc81960b1903b13b448093c9bbd";
