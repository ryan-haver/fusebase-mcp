...
async function main() {
    await makePage("Fresh Format Test", [
        { type: "heading", level: 1, children: [{ text: "Fresh Format Test" }] },
        {
            type: "table",
            columns: [
                { text: "Desc", type: "text" },
                { text: "Flags", type: "rating", format: { ratingIcon: "flag" } },
                { text: "Hearts", type: "rating", format: { ratingIcon: "heart" } },
                { text: "Date YYYY", type: "date", format: { dateFormat: "yyyy/mm/dd" } },
            ],
            rows: [
                {
                    cells: [
                        { cellType: "text", children: [{ text: "R1" }] },
                ...
                {
                    cells: [
                        { cellType: "text", children: [{ text: "R2" }] },
