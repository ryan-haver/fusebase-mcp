        ...
        if (options.isExtendedToolsEnabled()) {
          return {
            content: [
              {
                type: "text" as const,
                text: "Extended tools are already enabled for this session (165 total tools active).",
              },
            ],
          };
        }
        ...
        content: [
          {
            ...
            text: options.isExtendedToolsEnabled()
              ? "Current tier: all (165 tools active). To revert to core-only, restart the MCP server."
              : "Current tier: core (34 tools active). Call set_tool_tier with tier='all' to enable 131 extended tools.",
          },
        ],
      };
    },
