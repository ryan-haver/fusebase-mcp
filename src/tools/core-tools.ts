        ...
        content: [
          {
            ...
            text: options.isExtendedToolsEnabled()
              ? "Current tier: all (109 tools active). To revert to core-only, restart the MCP server."
